...
public class FrmManteProd extends JFrame {
	...
	void llenaCombo() {
		...
		/*demo 06 listado para llenar el cbo*/
		...
		List<Categoria>lstCategoria= em.createQuery("select a from Categoria a",Categoria.class).getResultList();
		 ...
		 /*se puso getIdcategoria para que el cbo tenga el numero que corresponde de 1 - 6*/
	...
	void listado() {
		...
		//Crear un listado de los productos
				...
				for(Producto p: listadoProductos) {
					...
					txtSalida.append("************************************************" + "\n");
					txtSalida.append("Id Producto : " + p.getIdProducto() + "\n");
					...
					//txtSalida.append("Id Categoria: " +Integer.toString(p.getCategoria())+"\n");
					
					/*Para llamar al cbo seleccionado y no numero debes hacer eso*/
					txtSalida.append("Id Categoria: " +p.getCategoria().getDescripcion()+"\n");
					
					
					txtSalida.append("Estado   : " +Integer.toString(p.getEstado())+"\n");
					/*txtSalida.append("Id Proveedor: " +Integer.toString(p.getIdProveedor())+"\n\n");*/		
					txtSalida.append("Id Proveedor: " +p.getIdProveedor().getNombre_rs()+"\n\n");
	...
	void registrar() {
		...
		int estado = 1 ; //valor por defecto  
